...
public class ContextMenuManager{
	...
	Rect contextMenuPosNodes=new Rect(5,125,350,270);
	Rect contextMenuPosLinks=new Rect(5,125,350,250);
	...
	public void ManageTooltip()
	{
		...
		if (ttMode!=0) {TooltipWindow(ttMode);}//DrawTooltip(ttMode);}
	}
	...
	void TooltipWindow(int mode)
	{
		...
		if (mode==1) 
		{
			contextMenuPosNodes=GUI.Window (1,contextMenuPosNodes,DrawTooltip,"",GUIStyle.none);
			GUI.Box(contextMenuPosNodes,"Контекстное Меню",new GUIStyle("window"));
		}
		else 
		{
			contextMenuPosLinks=GUI.Window (2,contextMenuPosLinks,DrawTooltip,"",GUIStyle.none);
